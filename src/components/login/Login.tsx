        ...
        <section className="loginContainer">
            ...
            <Card sx={{ minWidth: 400 }} className="login">
                <CardContent className="formWrapper">
                    <div className={`formElement ${userNameErr ? 'errorFormElement' : ''}`}>
                        <TextField
                            id="userName"
                            label="Email"
                            variant="standard"
                        ...
                        />
                        {userName !== '' &&
                            <CheckCircleOutlinedIcon color="primary" className="formActionIcons" />
                        }
                        {userNameErr &&
                            <span className="errorMsg">Please enter Username</span>
                        }
                    </div>
                    <div className={`formElement ${passwordErr ? 'errorFormElement' : ''}`}>
                        <TextField
                            id="password"
                        ...
                        />
                        {password !== '' &&
                            <VisibilityIcon color="primary" className="formActionIcons" onClick={handleShowPasswordClick} />
                        }
                        {passwordErr &&
