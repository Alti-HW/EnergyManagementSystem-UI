...
const UsersTable = ({
  ...
  selectedUsers,
  usersRolesList,
  roleFilter = "" // Add roleFilter prop here
}: UserTableProps) => {
        ...
        <Table sx={{ tableLayout: "fixed", backgroundColor: "#fff" }}>
          <TableHead>
            <TableRow>
              ...
              <TableCell ><Typography variant="caption" sx={{ fontWeight: 600 }}>Account</Typography></TableCell>
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell sx={{ width: "25%" }}>
                        <Box display="flex" alignItems="center" gap="4px">
                          <Icon sx={{ color: "green" }}><VerifiedUserIcon /></Icon>
                      ...
                      <TableCell sx={{ padding: 0.5, textAlign: "center" }}>
                        <IconButton onClick={(e) => { e.stopPropagation(); onUserEdit(index); }}>
