...
const ResponsiveDialog: React.FC<ResponsiveDialogProps> = ({ open, handleAddRoleModel }) => {
            ...
            <DialogContent sx={{ paddingTop: 2, paddingBottom: 3 }}>
                <Box display="flex" flexDirection="column" gap={2}>
                    ...
                    <FormControl fullWidth>
                        ...
                        <Select labelId="scope-label" id="permissions-select" label="Permissions" required>
                            {scope.map((el, index) => (
                                <MenuItem key={index} value={el}>
                                    {el}
                                </MenuItem>
