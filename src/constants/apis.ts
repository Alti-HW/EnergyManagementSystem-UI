...
export const users = {
  ...
  avaialbleRolesForUser: `${baseURL}/api/RoleMapping/user`,
  assignedRolesForUser: `${baseURL}/api/RoleMapping/user`,
  addRolesToUsers: `${baseURL}/api/RoleMapping/user`,
  removeRolesFromUser: `${baseURL}/api/RoleMapping/user`,
